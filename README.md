...
## Getting Started
The <a href= "/retinal_images_dataset.ipynb">`retinal_images_dataset.ipynb`</a> notebook can be directly run on Kaggle after loading the dataset in the Kaggle Kernel. Use Kaggle's Nvidia Tesla P100 GPU for faster training and evaluation.
### Pre-Requisites
